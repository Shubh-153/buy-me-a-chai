...
## 2026-08-17 — Badge click opens a card modal instead of jumping straight to the UPI app

- **Why:** clicking "Sponsor via UPI" used to navigate directly to `upi://pay...`, which is jarring on desktop (nothing happens/broken link) and doesn't give the sponsor a chance to see who/what they're paying before their UPI app launches.
